...
export const SlurmCourseStructure = {
  ...
  level1: {
    ...
    description: 'Pagrindinis SLURM darbo krūvio valdymo kursas DevOps/SysAdmin specialistams',
    duration: '40 akademinių valandų',
    targetAudience: 'Sistemos administratoriai, pradedantys DevOps specialistai',
    sections: [
      {
        id: 'slurm-l1-intro',
        title: 'SLURM Įvadas',
        ...
        lessons: [
          {
            ...
            type: 'lesson',
            duration: '1.5 val.',
            description: 'Supažindimas su aukšto našumo kompiuterijos konceptais'
          },
          {
            id: 'slurm-l1-intro-2',
          ...
          },
          {
            ...
            type: 'exercise',
            duration: '1 val.',
            description: 'Praktinis SLURM aplinkos sukūrimas virtualioje aplinkoje'
          }
        ]
      },
      {
  ...
  level2: {
    ...
    slug: 'slurm-paženges',
    description: 'Pažangus SLURM darbo krūvio valdymo kursas patyrusiems specialistams',
...
export type SlurmCourseSection = typeof SlurmCourseStructure[SlurmCourseLevel]['sections'][number]
